...
python3 code/main.py --cfg cfg/filmant7.yml --logcomet > filmant7_clevr_$SLURM_JOBID.out 2>&1 &
python3 code/main.py --cfg cfg/filmant8.yml --logcomet > filmant8_clevr_$SLURM_JOBID.out 2>&1 &
