...
python3 code/main.py --cfg cfg/filmant8.yml --resume-model data/filmant8_clevr/Model/model_checkpoint_000020.pth --logcomet > filmant8_clevr_$SLURM_JOBID.out 2>&1 &
