...
python3 code/main.py --cfg cfg/filmant1.yml --logcomet > filmant_clevr_$SLURM_JOBID.out 2>&1 &
python3 code/main.py --cfg cfg/filmant1.yml --logcomet > filmant2_clevr_$SLURM_JOBID.out 2>&1 &
