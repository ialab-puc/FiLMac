...
python3 code/main.py --cfg cfg/filmant2.yml --resume-model data/filmant2_clevr/Model/model_checkpoint_000015.pth --logcomet > filmant2_clevr_$SLURM_JOBID.out 2>&1 &
python3 code/main.py --cfg cfg/filmant9.yml --logcomet > filmant9_clevr_$SLURM_JOBID.out 2>&1 &
